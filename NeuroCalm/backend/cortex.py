...
APP_CLIENT_ID = "m24gFZBrwNcykkdlWKxdLlp3eIIFP3fuMG3qOzWx"  # your Client ID
APP_CLIENT_SECRET = "5mm3lFDrPD62hVly3rcH1sF7frTqIW2QFUyfDJiezPFXHaN6hiSxS5XbjR2u9WSEaAIncAGEEVpnnqdCdudrOIwtBK1SUijMRoPDAxMI7SCgqQfBrdzBUKUxh6sz0mfg"
APP_ID = "com.dhanashrikatkar.NeuroCalm"
...
def main():
    try:
        ...
        with open(CSV_FILE, "w", newline="") as f:
            ...
            SELECTED_CHANNELS = ["TP9", "AF7", "AF8", "TP10", "RightAUX"]
            BAND_NAMES = ["TP9", "AF7", "AF8", "TP10", "RightAUX"]  # assumed ordering in pow frames
